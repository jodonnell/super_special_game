class OnscreenSprites {
  constructor() {
    ...
    this.swappers = [new Swapper(500, 450), new Swapper(20, canvas.height - 340)];
    this.buzzsaws = [
      ...
      new BuzzSaw(-40, canvas.height - 200, images.pallet.a, 225),
      new BuzzSaw(-40, canvas.height - 380, images.pallet.b, 225),
      new BuzzSaw(-40, canvas.height - 572, images.pallet.a, 225),
    ];
    this.FX = [];
    this.BG = [
